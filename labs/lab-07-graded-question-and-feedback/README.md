...
The camping module needs a defensible knowledge check on campsite-selection criteria.

## Objective

Add a graded question with plausible distractors, feedback, scoring and accessible response behaviour.
