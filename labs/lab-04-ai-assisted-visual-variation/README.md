...
Creative Minds wants to test a western-poster visual direction without losing the approved baseline or provenance record.

## Objective

Create an AI-assisted visual variation, evaluate it against the brief and retain transparent provenance evidence.
